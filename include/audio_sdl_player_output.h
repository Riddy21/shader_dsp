...
class AudioSDLOutputNew : public AudioOutputNew {
public:
    /**
    ...
    */
    AudioSDLOutputNew(const unsigned frames_per_buffer, const unsigned sample_rate, const unsigned channels) : 
        AudioOutputNew(frames_per_buffer, sample_rate, channels),
        m_device_id(0) {}
    /**
