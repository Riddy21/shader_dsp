...
private:
     ...
     */
    static void timer_callback(int arg) {
        instance->timer(arg);
    }
     ...
     */
    void start_push_data_to_output_buffers_thread();
    ...
    float * m_output_buffer_data = nullptr; // Output buffer data
