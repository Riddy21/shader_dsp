...
TEST_CASE("AudioRenderer") {
    ...
    render_stage2.add_parameter(input_audio_texture_parameter);
    render_stage2.add_parameter(stream_audio_texture_parameter);
    render_stage2.add_parameter(output_audio_texture_parameter);
    ...
    input_audio_texture_parameter2.datatype = AudioRenderStageParameter::DataType::FLOAT;
    input_audio_texture_parameter2.format = AudioRenderStageParameter::Format::RED; 
    input_audio_texture_parameter2.internal_format = AudioRenderStageParameter::InternalFormat::R32F;
    ...
    stream_audio_texture_parameter2.datatype = AudioRenderStageParameter::DataType::FLOAT;
    stream_audio_texture_parameter2.format = AudioRenderStageParameter::Format::RED;
    stream_audio_texture_parameter2.internal_format = AudioRenderStageParameter::InternalFormat::R32F;
    ...
    output_audio_texture_parameter2.datatype = AudioRenderStageParameter::DataType::FLOAT;
    output_audio_texture_parameter2.format = AudioRenderStageParameter::Format::RED;
    output_audio_texture_parameter2.internal_format = AudioRenderStageParameter::InternalFormat::R32F;
    ...
    input_audio_texture_parameter3.datatype = AudioRenderStageParameter::DataType::FLOAT;
    input_audio_texture_parameter3.format = AudioRenderStageParameter::Format::RED;
    input_audio_texture_parameter3.internal_format = AudioRenderStageParameter::InternalFormat::R32F;
    ...
    stream_audio_texture_parameter3.datatype = AudioRenderStageParameter::DataType::FLOAT;
    stream_audio_texture_parameter3.format = AudioRenderStageParameter::Format::RED;
    stream_audio_texture_parameter3.internal_format = AudioRenderStageParameter::InternalFormat::R32F;
    ...
    output_audio_texture_parameter3.datatype = AudioRenderStageParameter::DataType::FLOAT;
    output_audio_texture_parameter3.format = AudioRenderStageParameter::Format::RED;
    output_audio_texture_parameter3.internal_format = AudioRenderStageParameter::InternalFormat::R32F;
    ...
    input_audio_texture_parameter4.datatype = AudioRenderStageParameter::DataType::FLOAT;
    input_audio_texture_parameter4.format = AudioRenderStageParameter::Format::RED;
    input_audio_texture_parameter4.internal_format = AudioRenderStageParameter::InternalFormat::R32F;   
    ...
    stream_audio_texture_parameter4.datatype = AudioRenderStageParameter::DataType::FLOAT;
    stream_audio_texture_parameter4.format = AudioRenderStageParameter::Format::RED;
    stream_audio_texture_parameter4.internal_format = AudioRenderStageParameter::InternalFormat::R32F;
    ...
    output_audio_texture_parameter4.link_name = "stream_audio_texture";
    output_audio_texture_parameter4.type = AudioRenderStageParameter::Type::STREAM_OUTPUT;
    output_audio_texture_parameter4.datatype = AudioRenderStageParameter::DataType::FLOAT;
    output_audio_texture_parameter4.format = AudioRenderStageParameter::Format::RED;
    output_audio_texture_parameter4.internal_format = AudioRenderStageParameter::InternalFormat::R32F;
